...
1. Display the actions in the `/whisk.system/utils` package.
  ...
  ```
  ```
  package /whisk.system/utils
   action /whisk.system/utils/cat: Concatenate array of strings
   action /whisk.system/utils/head: Filter first K array elements and discard rest
   action /whisk.system/utils/date: Get current date and time
   action /whisk.system/utils/sort: Sort array
   action /whisk.system/utils/split: Split a string into an array of strings
   action /whisk.system/utils/echo: Return the same input arguments
  ```
